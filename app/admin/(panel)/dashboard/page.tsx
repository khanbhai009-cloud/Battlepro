              ...
              <div key={w.id} className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:bg-gray-50 transition-colors">
                <div>
                  <div className="font-bold text-sm flex items-center gap-2">
                    {w.user}
                    <span className="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">{w.id}</span>
                  </div>
                  <div className="text-xs text-muted mt-0.5">Requested {w.time}</div>
                </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="w-[84%] bg-amber-500 h-full rounded-full" />
              </div>
              <p className="text-[10px] text-muted mt-1.5">Approaching daily limit.</p>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="w-[99.8%] bg-green-500 h-full rounded-full" />
              </div>
            </div>
