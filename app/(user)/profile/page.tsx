...
import { Trophy, Wallet, Star, GamepadIcon, LogOut } from "lucide-react";
      ...
      <div className="card-base flex flex-col sm:flex-row items-start sm:items-center gap-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-[11px] font-bold text-muted uppercase tracking-widest capitalize">
              {user?.role ?? "Player"}
            </span>
          </div>
        </div>
        ...
        <form action={destroySession}>
          <button
            type="submit"
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold text-red-500 hover:bg-red-50 transition-colors border border-red-100"
          >
            <LogOut size={15} />
            Logout
          </button>
