...
function proxy(request) {
    ...
    if (pathname.startsWith("/staff") && pathname !== "/staff/login") {
        if (!sessionToken || userRole !== "staff" && userRole !== "admin") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/staff/login", request.url));
        }
    }
    // 3. Prevent already-logged-in users from revisiting auth pages
    if (sessionToken && (pathname === "/login" || pathname === "/register")) {
        if (userRole === "admin") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/admin/dashboard", request.url));
        if (userRole === "staff") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/staff/dashboard", request.url));
    ...
    if (sessionToken && pathname === "/staff/login") {
        if (userRole === "staff" || userRole === "admin") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/staff/dashboard", request.url));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/login", request.url));
    }
